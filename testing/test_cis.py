...
#        cis.add_colormap(name, path)
    ...
    def __test_read_colormap_url(self):
        pathToColormap = 'https://raw.githubusercontent.com/EthanS94/cinemasci/new-colormap-links/testing/gold/cis/file.cis/colormaps/blue-orange-div.xml'
        b_o_div = cinemasci.cis.colormap.colormap(pathToColormap)
        
        # check values read in
        self.assertTrue( b_o_div.pathToFile == 'https://raw.githubusercontent.com/EthanS94/cinemasci/new-colormap-links/testing/gold/cis/file.cis/colormaps/blue-orange-div.xml')
        self.assertTrue( b_o_div.name == 'blue-orange-div')
        #self.assertTrue( b_o_div.name == 'Divergent 1')
        self.assertTrue( len(b_o_div.points) == 47 )
